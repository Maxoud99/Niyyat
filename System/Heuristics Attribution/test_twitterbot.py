#!/usr/bin/env python
"""
Test the Attribution Pipeline (H1-H8) on the TwiBot-20 dataset
(mixed_error_pipeline_twitter: tab_err unintentional + fast-plausible adversarial).
...
# -- Config (TwiBot-20 specific) --
TARGET_COL = "label"
CODEPENDENT_PAIRS = []          # no known codependent pairs
SENSITIVE_COLS = []             # no sensitive cols in this dataset
RANDOM_STATE = 42
N_SPLITS = 5
...
if __name__ == "__main__":
    ...
    run_dir = os.path.join(OUTPUT_ROOT, "run_twitter_" + timestamp)
    ...
    try:
        print("=" * 70)
        print("  ATTRIBUTION PIPELINE -- TWITTERBOT DATASET EVALUATION")
        print("  Run: " + timestamp)
        print("  Output: " + run_dir)
        print("=" * 70)

        s = run_dataset(
            "Mixed SOTA (TwiBot-20)", load_twitter_dataset, run_dir
        )
