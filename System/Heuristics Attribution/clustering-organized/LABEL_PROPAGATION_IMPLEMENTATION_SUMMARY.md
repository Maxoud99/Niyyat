...
### **General Features**
✅ Cell-level error detection (not record-level)  
...
### **1. Random Forest Wins for Error Detection**
- **4x better F1 on error class** (0.42-0.44 vs 0.10-0.27)
- Best for catching minority class (errors = 2.35%)
- Fastest runtime (0.35-0.37s)
- **Recommended for production error detection**

### **2. Label Propagation Wins for Overall Accuracy**
- **Highest accuracy** (97.7-97.8% vs 94.4-97.6%)
- Best F1 on correct class (0.9887-0.9889)
...
**Question:** Can label propagation replace the classifier for intent/error detection?

**Answer:** **Depends on the objective:**

1. **For Error Detection (catching bad cells):**  
...
**Conclusion:** Random Forest is the clear winner for **error detection** (primary use case).
