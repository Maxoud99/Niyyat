...
Compares **3 approaches** for cell-level intent classification:
...
|--------|---------|----------|-------|
| **RandomForest** | 0.9745 | **Intent Classification** (F1_error=0.42) | ⚡ Fast (0.37s) |
| **LabelSpreading** | 0.9678 | **Overall Accuracy** (97.77%) | 🐢 Slow (1.67s) |
| **LabelPropagation** | 0.9677 | **Unintentional Class** (F1=0.99) | 🐢 Slow (2.34s) |
| **ClusterConstrained** | 0.9649 | Fast prediction | ⚡ Very Fast (~0s) |

## 💡 Recommendation

**For intent classification:** Use **Random Forest** (4x better at detecting errors)  
