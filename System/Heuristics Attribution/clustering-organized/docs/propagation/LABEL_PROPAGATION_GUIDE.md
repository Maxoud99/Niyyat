...
This guide documents the **Label Propagation vs Random Forest** comparison framework for **cell-level intent classification** in the Adult Income dataset (v2).
...
|---------------------|---------|--------------|------------------------------------------|
| LabelSpreading      | 0.9677  | 0.9776       | Best overall accuracy & unintentional class    |
| LabelPropagation    | 0.9677  | 0.9776       | Tied with LabelSpreading                 |
| ClusterConstrained  | 0.9649  | 0.9765       | Fast but fails on intentional class (F1=0)     |
| RandomForest        | 0.9638  | 0.9602       | **Best intent classification (F1_error=0.42)** |

---

## 🔍 Key Insights

### 1. **Random Forest Excels at Intent Classification**
...
- Excellent on unintentional class (F1_correct ~0.99)
...
### 4. **Trade-offs**
| Method              | Intent Classification | Overall Accuracy | Speed | Complexity |
|---------------------|-----------------|------------------|-------|------------|
| RandomForest        | ⭐⭐⭐⭐⭐     | ⭐⭐⭐⭐        | ⭐⭐⭐⭐⭐ | Low       |
...
1. **Hybrid Approach:** Combine RF for intent classification + LP for unintentional class
