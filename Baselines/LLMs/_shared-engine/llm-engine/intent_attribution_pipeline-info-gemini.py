...
- Replica of info-qwen architecture adapted for Gemini API
"""
...
# Outputs
OUT_LABELS_CSV = "/home/mohamed/error_injector/llms_baseline/adult_income_dataset/tenth-trial/results/model_outputs/local-llms/second-trial-gemini-pro/intent_labels.csv"
OUT_EXPL_CSV   = "/home/mohamed/error_injector/llms_baseline/adult_income_dataset/tenth-trial/results/model_outputs/local-llms/second-trial-gemini-pro/intent_explanations.csv"
...
def make_group_prompt(clean_row: Dict[str, str],
    ...
    """
    Info-enhanced prompt with DIFFS and rubric (same as info-qwen).
    """
    role_block = (
