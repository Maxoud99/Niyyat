...
# -*- coding: utf-8 -*-
"""
Intent Attribution — Three R1-Qwen Variants — TFM-Inject Adult Income Dataset
==============================================================================
...
def _bundle(clean, dirty, blind, with_diffs: bool = False) -> dict:
    b = {"columns": ADULT_FEATURE_COLS, "clean_row": clean, "dirty_row": dirty, "change_mask": blind}
    if with_diffs:
...
def main() -> None:
    ...
    if args.out_dir is None:
        ...
        args.out_dir = os.path.join(_SCRIPT_DIR, "output", f"tfm_sota_r1qwen_{ts}")
