...
# -*- coding: utf-8 -*-
"""
TabFact Intent Attribution — Qwen-2.5 (port 6300), few-shots variant.
Serves via TGI at port configured in ``_local_llm_base.MODELS["qwen"]``.

Output directory: <this-folder>/outputs/few-shots-qwen/
"""
