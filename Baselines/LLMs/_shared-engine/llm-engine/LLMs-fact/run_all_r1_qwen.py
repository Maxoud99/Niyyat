...
# -*- coding: utf-8 -*-
"""
Run ALL three intent-attribution variants on TabFact for DeepSeek-R1-Qwen.
====================================================================

Sequentially executes:
    1. bareminimum  →  outputs/baremin-r1-qwen/
    2. info         →  outputs/info-r1-qwen/
    3. few-shots    →  outputs/few-shots-r1-qwen/

Requires the DeepSeek-R1-Qwen TGI container to be running on port 6800.

Examples
--------
    python run_all_r1_qwen.py                       # full dataset
    python run_all_r1_qwen.py --max-records 30      # smoke test
    python run_all_r1_qwen.py --only info           # one variant
    python run_all_r1_qwen.py --skip bareminimum
"""
...
VARIANTS = {
    "bareminimum": {
        ...
        "out_dir":   os.path.join(HERE, "outputs", "baremin-r1-qwen"),
    },
    "info": {
        "prompt_fn": make_prompt_info,
        "out_dir":   os.path.join(HERE, "outputs", "info-r1-qwen"),
    },
    "few-shots": {
        "prompt_fn": make_prompt_fewshot,
        "out_dir":   os.path.join(HERE, "outputs", "few-shots-r1-qwen"),
    },
}
