...
# -*- coding: utf-8 -*-
"""
Run ALL three intent-attribution variants on TabFact for Mixtral.
====================================================================

Sequentially executes:
    1. bareminimum  →  outputs/baremin-mixtral/
    2. info         →  outputs/info-mixtral/
    3. few-shots    →  outputs/few-shots-mixtral/

Requires the Mixtral TGI container to be running on port 6000.

Examples
--------
    python run_all_mixtral.py                       # full dataset
    python run_all_mixtral.py --max-records 30      # smoke test
    python run_all_mixtral.py --only info           # one variant
    python run_all_mixtral.py --skip bareminimum
"""
...
VARIANTS = {
    "bareminimum": {
        ...
        "out_dir":   os.path.join(HERE, "outputs", "baremin-mixtral"),
    },
    "info": {
        "prompt_fn": make_prompt_info,
        "out_dir":   os.path.join(HERE, "outputs", "info-mixtral"),
    },
    "few-shots": {
        "prompt_fn": make_prompt_fewshot,
        "out_dir":   os.path.join(HERE, "outputs", "few-shots-mixtral"),
    },
}
