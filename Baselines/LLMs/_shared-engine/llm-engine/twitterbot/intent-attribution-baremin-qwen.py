...
------------------------------------------------------------------------------------------
Adapted from the Llama bare-minimum pipeline for Qwen-2.5 (via TGI).
...
# Outputs
OUT_DIR = "/home/mohamed/error_injector/llms_baseline/klim-kireev/datasets/twitter-bot/intent-attribution/outputs/bare-min-qwen"
...
def make_chunk_prompt(clean_rows: List[Dict[str, str]],
    ...
    Formatted with Qwen-2.5 chat template.
    """
    sys_rules = """Rules:
