...
"""
Record-level Intent Attribution for Twitter Bot Detection via Google Gemini — Few-shot, Robust JSON
------------------------------------------------------------------------------------
Gemini API with few-shot examples for Twitter bot detection:
...
- Accept multiple JSON schemas for robust parsing
...
# Outputs
OUT_DIR = "/home/mohamed/error_injector/llms_baseline/klim-kireev/datasets/twitter-bot/intent-attribution/outputs/few-shots-gemini"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Twitter Bot Intent Attribution Pipeline (Few-Shot Enhanced)")
    ...
    print("Few-Shot Enhanced with Rubric (Gemini)")
    print("="*60)
