...
# -*- coding: utf-8 -*-
"""
TabFact Intent Attribution — DeepSeek-R1-Qwen (port 6800), few-shots variant.
Serves via TGI at port configured in ``_local_llm_base.MODELS["r1-qwen"]``.

Output directory: <this-folder>/outputs/few-shots-r1-qwen/
"""
...
from _prompts import make_prompt_fewshot
...
if __name__ == "__main__":
    ...
    run_pipeline_tgi(
        make_core_prompt=  make_prompt_fewshot,
        model_key=         MODEL_KEY,
        out_dir=           args.out,
