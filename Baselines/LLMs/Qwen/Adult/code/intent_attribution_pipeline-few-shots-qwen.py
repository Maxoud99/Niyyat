...
- Support both "decision" and "intentional" keys
...
# Outputs
OUT_LABELS_CSV = "/home/mohamed/error_injector/llms_baseline/adult_income_dataset/tenth-trial/results/model_outputs/local-llms/third-trial-qwen/intent_labels.csv"
OUT_EXPL_CSV   = "/home/mohamed/error_injector/llms_baseline/adult_income_dataset/tenth-trial/results/model_outputs/local-llms/third-trial-qwen/intent_explanations.csv"
# Adult schema
ADULT_COLS = [
...
def salvage_decisions_from_prose(llm_text: str, global_ids: List[int]) -> Optional[List[Tuple[int,int,str]]]:
    ...
    # 2) minimal map anywhere in text
