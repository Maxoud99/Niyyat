...
# -*- coding: utf-8 -*-
"""
Run ALL three intent-attribution variants on TabFact for Llama-3.
====================================================================

Sequentially executes:
    1. bareminimum  →  outputs/baremin-llama/
    2. info         →  outputs/info-llama/
    3. few-shots    →  outputs/few-shots-llama/

Requires the Llama-3 TGI container to be running on port 6100.

Examples
--------
    python run_all_llama.py                       # full dataset
    python run_all_llama.py --max-records 30      # smoke test
    python run_all_llama.py --only info           # one variant
    python run_all_llama.py --skip bareminimum
"""
...
VARIANTS = {
    "bareminimum": {
        ...
        "out_dir":   os.path.join(HERE, "outputs", "baremin-llama"),
    },
    "info": {
        "prompt_fn": make_prompt_info,
        "out_dir":   os.path.join(HERE, "outputs", "info-llama"),
    },
    "few-shots": {
        "prompt_fn": make_prompt_fewshot,
        "out_dir":   os.path.join(HERE, "outputs", "few-shots-llama"),
    },
}
