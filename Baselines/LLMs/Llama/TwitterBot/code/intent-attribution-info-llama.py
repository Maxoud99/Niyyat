...
Adapted from the bare-min pipeline with enhanced prompt for local LLM (Llama via TGI).
...
# Outputs
OUT_DIR = "/home/mohamed/error_injector/llms_baseline/klim-kireev/datasets/twitter-bot/intent-attribution/outputs/info-llama"
...
def run_pipeline(manip_path: str, correct_path: str, masks_path: str, max_records: Optional[int] = None):
    ...
    print("="*80)
    print(f"Model:              Meta-Llama-3-70B-Instruct (Info-Enhanced)")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Twitter Bot Intent Attribution Pipeline (Info-Enhanced with Llama)")
    ...
    print("Info-Enhanced with Rubric (Llama-3-70B)")
    print("="*80)
