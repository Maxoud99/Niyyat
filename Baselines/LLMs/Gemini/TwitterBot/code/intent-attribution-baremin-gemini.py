...
------------------------------------------------------------------------------
Adapted from the adult income dataset pipeline for Twitter bot data.
...
# Outputs
OUT_DIR = "/home/mohamed/error_injector/llms_baseline/klim-kireev/datasets/twitter-bot/intent-attribution/outputs/bare-min-gemini"
        ...
        if parsed is None:
            ...
            for rid in global_ids:
                for col in TWITTER_BOT_COLS:
                    ...
                    if col != "user_id" and mask_rows[local_idx][col] == "1":
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Twitter Bot Intent Attribution Pipeline")
